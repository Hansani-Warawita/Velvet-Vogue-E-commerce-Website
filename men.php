...
<head>
    ...
    <title>Men's Collection - Velvet Vogue</title>
...
<body>
    ...
    <section class="section men-section">
        <div class="section-header">
            ...
            <p class="section-description">Explore our complete collection of professional and casual wear for the sophisticated gentleman</p>
        </div>
        <div class="product-grid">
            <?php 
            include('server/connection.php');
            
            $stmt = $conn->prepare("SELECT product_id, name, description, price, image, stock FROM products WHERE category_id = 2");
            $stmt->execute();
