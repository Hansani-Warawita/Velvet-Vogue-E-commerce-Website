...
<head>
    ...
    <title>Women's Collection - Velvet Vogue</title>
...
<body>
    ...
    <section class="section women-section">
        <div class="section-header">
            ...
            <p class="section-description">Discover our complete collection of elegant and fashionable clothing for the modern woman</p>
        </div>
        <div class="product-grid">
            <?php 
            include('server/connection.php');
            
            $stmt = $conn->prepare("SELECT product_id, name, description, price, image, stock FROM products WHERE category_id = 1");
            $stmt->execute();
